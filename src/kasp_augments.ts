(function() {
    ...
    const addCustomStyles = () => {
        if (document.getElementById('custom-specs-styles')) return;
    ...
    const injectButtons = () => {
        ...
        cardsImgs.forEach(img => {
            ...
            if (existingBtn && (existingBtn as HTMLElement).dataset.url !== url) {
                existingBtn.remove();
                existingBtn = null;
            }
    ...
    function updateLiveStats() {
        ...
        const deviceData = deviceSpecsDB[(deviceImg as HTMLImageElement).src];
