(function() {
    ...
    let isCategorySwitch: boolean = true;
    let categorySwitchTimeout: ReturnType<typeof setTimeout> | null = setTimeout(() => { isCategorySwitch = false; }, 2000);
    ...
    function isRubyButton(): boolean {
        ...
        const btn = document.querySelector('.DialogContainerComponentStyle-enterButton.DialogContainerComponentStyle-getRubyButton') as HTMLElement | null;
        if (!btn) return false;
    ...
    function clickCancel(): boolean {
        ...
        const btn = document.querySelector('.DialogContainerComponentStyle-keyButton') as HTMLElement | null;
        if (btn) {
            btn.click();
            return true;
        }
    ...
    function shouldShowQuickButtons(): boolean {
        if (localStorage.getItem('k_auto_upgrade') === 'false') return false;
    ...
    document.addEventListener('click', (e: MouseEvent) => {
        ...
        if (menuCategory || mainGarageBlock || backButton) {
            ...
            if (categorySwitchTimeout) clearTimeout(categorySwitchTimeout);
